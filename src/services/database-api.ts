...
import { DatabaseService, ReplayRecordDAO, MoviePlaybackProgressDAO } from './database';
...
export class DatabaseApiService {
  ...
  static async getLatestPlaybackProgress(movieId: string): Promise<ApiResponse<MoviePlaybackProgress | null>> {
    return MoviePlaybackProgressDAO.getLatestProgressByMovieId(movieId);
  }

  static async getPlaybackProgressByEpisode(
    movieId: string,
    sourceKey: string,
    episodeUrl: string
  ): Promise<ApiResponse<MoviePlaybackProgress | null>> {
    return MoviePlaybackProgressDAO.getProgressByEpisode(movieId, sourceKey, episodeUrl);
  }

  static async savePlaybackProgress(
    payload: PlaybackProgressPayload
  ): Promise<ApiResponse<MoviePlaybackProgress>> {
    return MoviePlaybackProgressDAO.upsertProgress(payload);
  }
...
export const databaseAPI = {
  ...
  getLatestPlaybackProgress: DatabaseApiService.getLatestPlaybackProgress,
  getPlaybackProgressByEpisode: DatabaseApiService.getPlaybackProgressByEpisode,
  savePlaybackProgress: DatabaseApiService.savePlaybackProgress,
  // 其他API
