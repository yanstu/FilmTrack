...
export interface Movie extends BaseEntity {
  ...
  play_profile_id?: string | null;
  play_profile_name?: string | null;
  play_source_key?: string | null;
  play_source_name?: string | null;
  play_vod_id?: string | null;
  play_vod_name?: string | null;
  play_group_name?: string | null;
  play_episode_name?: string | null;
  play_episode_url?: string | null;
  play_quality_label?: string | null;
  play_selection_mode?: 'auto' | 'manual' | null;
  play_match_score?: number | null;
  play_playback_rate?: number | null;
  play_last_played_at?: string | null;
  date_added: string;
  date_updated: string;
  watch_count: number;
  tags?: string[] | null;
...
export interface AppSettings {
  ...
  videoSource: SourceProfileSettings;
}
...
export type QualityPriority = 'quality' | 'update' | 'balanced';

export interface SourceProfileSettings {
  activeProfileId: string;
  autoSelectBestSource: boolean;
  resumePlayback: boolean;
  preferManualSource: boolean;
...
export interface MoviePlaybackProgress extends PlaybackProgressPayload {
  id: string;
  lastPlayedAt: string;
  createdAt: string;
  updatedAt: string;
...
export interface VideoStreamResource {
  url: string;
  contentType: string;
  status: number;
  textData?: string;
