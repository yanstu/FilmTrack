<template>
  <div class="mb-4 animate-fade-in-up" style="animation-delay: 0.05s;">
    <h1
      class="text-2xl sm:text-3xl lg:text-4xl font-bold mb-2 cursor-pointer hover:text-blue-200 transition-all duration-200 max-w-full movie-title-shadow"
    ...
    <p
      ...
      class="text-base sm:text-lg lg:text-xl text-gray-300 cursor-pointer hover:text-blue-200 transition-all duration-200 max-w-full movie-subtitle-shadow"
  ...
  <div class="flex flex-wrap items-center gap-x-6 gap-y-2 mb-4 animate-fade-in-up" style="animation-delay: 0.1s;">
