    ...
    try {
      ...
      const query = `
        INSERT INTO movies (
          ...
          watched_date, play_profile_id, play_profile_name, play_source_key, play_source_name, play_vod_id,
          play_vod_name, play_group_name, play_episode_name, play_episode_url, play_quality_label,
          play_selection_mode, play_match_score, play_playback_rate, play_last_played_at,
          watch_count, date_added, date_updated, created_at, updated_at, tags
      ...
      const params = [
        ...
        normalizedMovie.play_profile_id || null,
        normalizedMovie.play_profile_name || null,
        normalizedMovie.play_source_key || null,
        normalizedMovie.play_source_name || null,
        normalizedMovie.play_vod_id || null,
        normalizedMovie.play_vod_name || null,
        normalizedMovie.play_group_name || null,
        normalizedMovie.play_episode_name || null,
        normalizedMovie.play_episode_url || null,
        normalizedMovie.play_quality_label || null,
        normalizedMovie.play_selection_mode || null,
        normalizedMovie.play_match_score || null,
        normalizedMovie.play_playback_rate ?? 1,
        normalizedMovie.play_last_played_at || null,
      ...
      const newMovie: Movie = {
        ...
        play_profile_id: normalizedMovie.play_profile_id || null,
        play_profile_name: normalizedMovie.play_profile_name || null,
        play_source_key: normalizedMovie.play_source_key || null,
        play_source_name: normalizedMovie.play_source_name || null,
        play_vod_id: normalizedMovie.play_vod_id || null,
        play_vod_name: normalizedMovie.play_vod_name || null,
        play_group_name: normalizedMovie.play_group_name || null,
        play_episode_name: normalizedMovie.play_episode_name || null,
        play_episode_url: normalizedMovie.play_episode_url || null,
        play_quality_label: normalizedMovie.play_quality_label || null,
        play_selection_mode: normalizedMovie.play_selection_mode || null,
        play_match_score: normalizedMovie.play_match_score || null,
        play_playback_rate: normalizedMovie.play_playback_rate ?? 1,
        play_last_played_at: normalizedMovie.play_last_played_at || null,
  ...
  static async updateMovie(movie: Partial<Movie> & { id: string }): Promise<ApiResponse<Movie>> {
    try {
      ...
      const mergedMovie: Movie = {
        ...
        play_profile_id: normalizedInput.play_profile_id ?? originalData.play_profile_id ?? null,
        play_profile_name: normalizedInput.play_profile_name ?? originalData.play_profile_name ?? null,
        play_source_key: normalizedInput.play_source_key ?? originalData.play_source_key ?? null,
        play_source_name: normalizedInput.play_source_name ?? originalData.play_source_name ?? null,
        play_vod_id: normalizedInput.play_vod_id ?? originalData.play_vod_id ?? null,
        play_vod_name: normalizedInput.play_vod_name ?? originalData.play_vod_name ?? null,
        play_group_name: normalizedInput.play_group_name ?? originalData.play_group_name ?? null,
        play_episode_name: normalizedInput.play_episode_name ?? originalData.play_episode_name ?? null,
        play_episode_url: normalizedInput.play_episode_url ?? originalData.play_episode_url ?? null,
        play_quality_label: normalizedInput.play_quality_label ?? originalData.play_quality_label ?? null,
        play_selection_mode: normalizedInput.play_selection_mode ?? originalData.play_selection_mode ?? null,
        play_match_score: normalizedInput.play_match_score ?? originalData.play_match_score ?? null,
        play_playback_rate: normalizedInput.play_playback_rate ?? originalData.play_playback_rate ?? 1,
        play_last_played_at: normalizedInput.play_last_played_at ?? originalData.play_last_played_at ?? null,
      ...
      const query = `
        UPDATE movies SET 
          ...
          watch_source = $22, watched_date = $23, play_profile_id = $24, play_profile_name = $25,
          play_source_key = $26, play_source_name = $27, play_vod_id = $28, play_vod_name = $29,
          play_group_name = $30, play_episode_name = $31, play_episode_url = $32, play_quality_label = $33,
          play_selection_mode = $34, play_match_score = $35, play_playback_rate = $36, play_last_played_at = $37,
          tags = $38, date_added = $39, date_updated = $40, updated_at = $41
        WHERE id = $42
      `
      ...
      const params = [
        ...
        mergedMovie.play_profile_id || null,
        mergedMovie.play_profile_name || null,
        mergedMovie.play_source_key || null,
        mergedMovie.play_source_name || null,
        mergedMovie.play_vod_id || null,
        mergedMovie.play_vod_name || null,
        mergedMovie.play_group_name || null,
        mergedMovie.play_episode_name || null,
        mergedMovie.play_episode_url || null,
        mergedMovie.play_quality_label || null,
        mergedMovie.play_selection_mode || null,
        mergedMovie.play_match_score || null,
        mergedMovie.play_playback_rate ?? 1,
        mergedMovie.play_last_played_at || null,
